...
async function createRoomNumber(req, res) {
    const newRoomNumber = await (0, room_service_1.createRoomNumberService)(req.body);
...
async function updateRoomNumber(req, res) {
    ...
    const newUpdate = await (0, room_service_1.updateRoomNumberService)(req.body, roomNumId);
...
async function deleteRoomNumber(req, res) {
    const delRoomNum = await (0, room_service_1.deleteRoomNumberService)(req.body);
...
async function getAllRoomNumber(req, res) {
    const roomNumber = await (0, room_service_1.getAllRoomsNumberService)();
    console.log("roomNumber");
    return res.status(201).json(roomNumber);
}
exports.getAllRoomNumber = getAllRoomNumber;
async function getRoomNumber(req, res) {
    const roomNumber = await (0, room_service_1.getSingleRoomNumberService)(req.body);
...
async function createRoom(req, res) {
    ...
    const newRoom = await (0, room_service_1.createRoomService)(req.body, hotelId, roomNumberId);
    return res.json(newRoom);
}
exports.createRoom = createRoom;
async function updateRoom(req, res) {
    const roomId = Number(req.params.roomId);
    const newUpdate = await (0, room_service_1.updateRoomService)(req.body, roomId);
    return res.status(201).json(newUpdate);
}
exports.updateRoom = updateRoom;
async function deleteRoom(req, res) {
    const roomId = Number(req.params.roomId);
    await (0, room_service_1.deleteRoomService)(roomId);
...
async function getRoom(req, res) {
    const roomId = Number(req.params.roomId);
    const room = await (0, room_service_1.getSingleRoomService)(roomId);

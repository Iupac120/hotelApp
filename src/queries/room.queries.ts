...
export const addRoom ='INSERT INTO room (title,price, max_people, description) VALUES($1, $2, $3, $4) RETURNING *'
export const updateHotelId:string = "UPDATE room SET rooms = $1 WHERE hotel_id = $2"
//create room numbers
...
export const updateRoomNumberById:string = "UPDATE room_numbers SET room_number = $1,unavailable_date = $2 WHERE room_number = $1"

...
export const findProductQuery = "SELECT FROM product WHERE product_id = $1 OR title = $2"
export const findProductIdQuery = "SELECT FROM product WHERE product_id = $1"
export const updateProductQuery = "UPDATE product SET title = $1, type = $2, description = $3, price = $4, image = $5, user_id = $6 WHERE product_id = $7"

...
function findSessions(query) {
    return __awaiter(this, void 0, void 0, function* () {
        return session_model_1.default.find(query).lean(); //lean means it will get only the query object
    });
}
...
function reIssueAccessToken({ refreshToken }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!user)
            return false;
        const accesToken = (0, jwt_utils_2.signJwt)(Object.assign(Object.assign({}, user), { session: session._id }), {
